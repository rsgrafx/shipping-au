defmodule Sendle.ConnTest do
  # TAKEN DIRECTLY FROM PHOENIX - FOR EXAMPLE PURPOSES.
  # * Sometimes you only need to take what you need.
  ...
  for method <- @http_methods do
    ...
    defmacro unquote(method)(conn, path_or_action, params_or_body \\ nil) do
      ...
      quote do
        Sendle.ConnTest.dispatch(unquote(conn), @endpoint, unquote(method),
